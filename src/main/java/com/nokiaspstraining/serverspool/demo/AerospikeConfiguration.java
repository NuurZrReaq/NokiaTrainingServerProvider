...
@EnableAerospikeRepositories(basePackages = "com.nokiaspstraining.serverspool.demo.repositories")
public class AerospikeConfiguration {
    ...
    public AerospikeClient aerospikeClient() {
        ...
        clientPolicy.writePolicyDefault.recordExistsAction = RecordExistsAction.REPLACE;
